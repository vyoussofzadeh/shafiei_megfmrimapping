...
%     cfg.covariancewindow = 'all';
    ...
    cfg.vartrllength     = 2;
    cfg.latency  = [-0.5, 2];
    gmean           = ft_timelockanalysis(cfg, a_data);
%     
%     cfg          = [];
%     cfg.fontsize = 6;
%     cfg.layout   = lay;
%     cfg.fontsize = 14;
%     % cfg.ylim     = [-5e-6 5e-6];
%     cfg.xlim     = [gmean.time(1) gmean.time(end)];
%     figure;
%     ft_multiplotER(cfg, gmean);
    
    
    figure,
    plot(gmean.time,gmean.avg,'color',[0,0,0.5]);
