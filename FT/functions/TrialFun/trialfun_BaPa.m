function    trl = trialfun_BaPa( cfg )
...
% % trigger_name = {'Ba-or-Pa','Ba','Pa','Tone',};
% % trigger_code:
%     64        -> Ba
%     128       -> Pa
%     32        -> Tone
...
Base_trigger_code = [ 64, 128, 32 ];
if stimulCode == 1
    trigger_code = Base_trigger_code( 1:2 );
else
    trigger_code = Base_trigger_code( stimulCode-1 );
end
%==========================================================================
%%
