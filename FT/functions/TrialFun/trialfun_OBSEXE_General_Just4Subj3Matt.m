function    trl = trialfun_OBSEXE_General_Just4Subj3Matt( cfg )

%-- => Trigger of Subject: 3Matt_MoNe003 has a problem for trigger Code =2.
%-- Sometimes Parallel port goes down from 2 to 0 before photodiode be
%activated.
...
% % trigger_code = {[2, 2048 + 4]}; %Just for subject 3Matt_MoNe003
%     
...
% cfg.trialfun = 'trialfun_OBSEXE_General';
...
Base_trigger_code = [2, 2048 + 4];%%Just for subject 3Matt_MoNe003
