...
sourcemodel_ft = [];
sourcemodel_ft.pos = sourcemodel.pos;
sourcemodel_ft.tri = sourcemodel.tri;
sourcemodel_ft.inside = true(size(sourcemodel.pos,1),1);
sourcemodel_ft.unit = 'mm';


hdm                = [];
hdm.bnd.pos        = sourcemodel_ft.pos; % template's inner skull surface
hdm.bnd.tri        = sourcemodel_ft.tri;
