...
addpath(genpath(cfg_main.p.spm))
spm_get_defaults
addpath(genpath(cfg_main.p.spmbf))
...
%%
D = spm_eeg_ft2spm(cfg_main.eint_data, cfg_main.subj);
...
savepath = ['ForwardModel_',cfg_main.subj];
