function    trl = trialfun_OBSEXE_ObserveStaticImage( cfg )

% This is the Trial Definition Function for 
...
% cfg.trialfun = 'trialfun_OBSEXE_ObserveStaticImage';
